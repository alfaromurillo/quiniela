...
\begin{itemize}
  ...
  \item \textbf{Resultado (\texttt{KXWCGAME-}) y ventaja
    (\texttt{KXWCSPREAD-}):}
    conjuntamente determinan $\Prob(M = m)$ para
    $m \in \{-2, -1, 0, 1, 2\}$, más las colas agregadas
    $\Prob(M \geq 3)$ y $\Prob(M \leq -3)$.
\end{itemize}
...
Las dos marginales de Kalshi proveen alrededor de 13 ecuaciones
independientes, dejando el sistema fuertemente subdeterminado.
