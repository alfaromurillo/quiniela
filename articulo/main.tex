...
\begin{figure}[tb]
  ...
  \caption{Efecto del parámetro de decaimiento $\gamma$ sobre la
    ...
    Los recuadros en la esquina superior derecha muestran los mapas
    de calor de marcadores canónicos estimados en condiciones neutras
    ($p_W = p_D = p_A = 1/3$) para cada valor de $\gamma$
    (mismo formato que la Figura~\ref{fig:historico}).}
  \label{fig:gamma}
\end{figure}
