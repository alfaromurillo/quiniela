...
el Equipo~A gana, las probabilidades $s_m^A$ de que lo haga
por exactamente $m$ goles ($m = 1, 2, 3, 4+$), y, dado que
gana el Equipo~B, las correspondientes $s_m^B$.
...
\begin{figure}[tb]
  ...
  \caption{Distribución de probabilidades de marcador $P(h,k)$ para
    Corea del Sur (Equipo~A) vs.\ Rep.\ Checa (Equipo~B), antes (izquierda)
