...
\paragraph{Ejemplo.}
Para un partido donde $P(0,0) = 0.10$, $P(1,0) = 0.18$,
$P(0,1) = 0.08$, $P(1,1) = 0.12$,
la predicción $1$-$0$ puede tener mayor valor esperado que $0$-$0$
incluso si $P(0,0) > P(1,0)$, porque $1$-$0$ también recibe 3 puntos
cuando el resultado es $2$-$0$ o $3$-$0$.
\TODO{Insertar ejemplo concreto del WC 2026 con tabla de E(a,b).}
...
disponibles en:
\begin{center}
  \url{https://github.com/USER/quiniela}  % TODO: reemplazar USER
\end{center}
bajo licencia MIT.
Las predicciones actualizadas se pueden consultar en:
\begin{center}
  \url{https://USER.github.io/quiniela/}  % TODO: reemplazar USER
\end{center}
