...
\begin{observacion}[Los empates nunca son predicciones óptimas]
\label{obs:nodraw}
...
ninguna predicción de empate en ninguna fase del torneo.
Esta predicción se confirma empíricamente: en los 48 partidos de la
fase de grupos y en los partidos eliminatorios disputados hasta la
fecha, el modelo propone en todos los casos una victoria de uno de los
dos equipos.
